...
import { createFaq } from "../actions/faq_actions";
...
const FaqAdd = () => {
  ...
  const { loading, error, success, faq } = faqCreate;
  ...
  const handleSubmit = (e) => {
    ...
    const { question, answer, status } = formValues;

    dispatch(createFaq({ question, answer, status }));
  };
  ...
  return (
    <>
      <div>
        <Breadcrumb currentPage="add faq" />
