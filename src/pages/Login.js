...
const Login = ({ location, history }) => {
  ...
  const redirectHome = "/admin/index";
  ...
  return (
    <>
      <section className="min-h-screen flex items-stretch text-white ">
        ...
        <div
          className="lg:w-1/2 w-full flex items-center bg-gray-500 justify-center text-center md:px-16 px-0 z-0"
          ...
          <div className="w-full py-6 z-20">
            ...
            <form className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto" onSubmit={handleSubmit}>
              ...
              <div className="px-4 pb-2 pt-4">
                <button onSubmit={handleSubmit} className="uppercase block w-full p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">
                  sign in
                </button>
              </div>
