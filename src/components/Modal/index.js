...
const Modal = ({ showModal, setShowModal, deleteHandler, selectID }) => {
  ...
  return (
    <>
      {showModal ? (
        ...
        onClick={closeModal}
      >
        <div className="w-full max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg bg-white sm:mx-2">
          <div className="">
            <div className="text-center p-5 flex-auto justify-center">
              ...
              <p className="text-md text-gray-500 font-semibold px-8">
