...
const Sidebar = ({ sidebarOpen }) => {
  ...
  return (
    <>
      <div
        className={`w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30 ${sidebarOpen ? '' : 'hidden'}`}
        id="main-nav"
      >
        <div className="w-full h-20 border-b flex px-4 items-center mb-8">
          <NavLink to="/admin/index" activeClassName="active">
        ...
        <div className="mb-4 px-4">
          ...
          <NavLink to="/admin/index" activeClassName="active">
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "index" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
          ...
          <NavLink to="/admin/quotes" activeClassName="active">
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "quotes" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "authors" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "categories" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <NavLink to="/admin/tags" activeClassName="active">
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "tags" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "users" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
          ...
          <NavLink to="/admin/faqs" activeClassName="active">
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "faqs" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
              <path d="M16.557,4.467h-1.64v-0.82c0-0.225-0.183-0.41-0.409-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H5.901v-0.82c0-0.225-0.185-0.41-0.41-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H3.442c-0.904,0-1.64,0.735-1.64,1.639v9.017c0,0.904,0.736,1.64,1.64,1.64h13.114c0.904,0,1.64-0.735,1.64-1.64V6.106C18.196,5.203,17.461,4.467,16.557,4.467 M17.377,15.123c0,0.453-0.366,0.819-0.82,0.819H3.442c-0.453,0-0.82-0.366-0.82-0.819V8.976h14.754V15.123z M17.377,8.156H2.623V6.106c0-0.453,0.367-0.82,0.82-0.82h1.639v1.23c0,0.225,0.184,0.41,0.41,0.41c0.225,0,0.41-0.185,0.41-0.41v-1.23h8.196v1.23c0,0.225,0.185,0.41,0.41,0.41c0.227,0,0.409-0.185,0.409-0.41v-1.23h1.64c0.454,0,0.82,0.367,0.82,0.82V8.156z"></path>
            </svg>
          ...
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "articles" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
              <path d="M16.557,4.467h-1.64v-0.82c0-0.225-0.183-0.41-0.409-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H5.901v-0.82c0-0.225-0.185-0.41-0.41-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H3.442c-0.904,0-1.64,0.735-1.64,1.639v9.017c0,0.904,0.736,1.64,1.64,1.64h13.114c0.904,0,1.64-0.735,1.64-1.64V6.106C18.196,5.203,17.461,4.467,16.557,4.467 M17.377,15.123c0,0.453-0.366,0.819-0.82,0.819H3.442c-0.453,0-0.82-0.366-0.82-0.819V8.976h14.754V15.123z M17.377,8.156H2.623V6.106c0-0.453,0.367-0.82,0.82-0.82h1.639v1.23c0,0.225,0.184,0.41,0.41,0.41c0.225,0,0.41-0.185,0.41-0.41v-1.23h8.196v1.23c0,0.225,0.185,0.41,0.41,0.41c0.227,0,0.409-0.185,0.409-0.41v-1.23h1.64c0.454,0,0.82,0.367,0.82,0.82V8.156z"></path>
            </svg>
        ...
        <div className="mb-4 px-4">
          ...
          <NavLink to="/admin/modal" activeClassName="active">
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "modal" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
              <path d="M16.557,4.467h-1.64v-0.82c0-0.225-0.183-0.41-0.409-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H5.901v-0.82c0-0.225-0.185-0.41-0.41-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H3.442c-0.904,0-1.64,0.735-1.64,1.639v9.017c0,0.904,0.736,1.64,1.64,1.64h13.114c0.904,0,1.64-0.735,1.64-1.64V6.106C18.196,5.203,17.461,4.467,16.557,4.467 M17.377,15.123c0,0.453-0.366,0.819-0.82,0.819H3.442c-0.453,0-0.82-0.366-0.82-0.819V8.976h14.754V15.123z M17.377,8.156H2.623V6.106c0-0.453,0.367-0.82,0.82-0.82h1.639v1.23c0,0.225,0.184,0.41,0.41,0.41c0.225,0,0.41-0.185,0.41-0.41v-1.23h8.196v1.23c0,0.225,0.185,0.41,0.41,0.41c0.227,0,0.409-0.185,0.409-0.41v-1.23h1.64c0.454,0,0.82,0.367,0.82,0.82V8.156z"></path>
            </svg>
            <span className="text-gray-700">Modal</span>
          </div>
          </NavLink>
          <NavLink to="/admin/gradient" activeClassName="active">
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "gradient" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
              <path d="M16.557,4.467h-1.64v-0.82c0-0.225-0.183-0.41-0.409-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H5.901v-0.82c0-0.225-0.185-0.41-0.41-0.41c-0.226,0-0.41,0.185-0.41,0.41v0.82H3.442c-0.904,0-1.64,0.735-1.64,1.639v9.017c0,0.904,0.736,1.64,1.64,1.64h13.114c0.904,0,1.64-0.735,1.64-1.64V6.106C18.196,5.203,17.461,4.467,16.557,4.467 M17.377,15.123c0,0.453-0.366,0.819-0.82,0.819H3.442c-0.453,0-0.82-0.366-0.82-0.819V8.976h14.754V15.123z M17.377,8.156H2.623V6.106c0-0.453,0.367-0.82,0.82-0.82h1.639v1.23c0,0.225,0.184,0.41,0.41,0.41c0.225,0,0.41-0.185,0.41-0.41v-1.23h8.196v1.23c0,0.225,0.185,0.41,0.41,0.41c0.227,0,0.409-0.185,0.409-0.41v-1.23h1.64c0.454,0,0.82,0.367,0.82,0.82V8.156z"></path>
            </svg>
          ...
          <NavLink to="/admin/table" activeClassName="active">
          <div className={`w-full flex items-center text-blue-400 h-10 pl-4 ${splitLocation[2] === "table" ? 'bg-gray-200': ''} hover:bg-gray-200 rounded-lg cursor-pointer`}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
        ...
        <div className="mb-4 px-4">
          ...
          <div className="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer" onClick={logoutHandler}>
            <svg className="h-6 w-6 fill-current mr-2" viewBox="0 0 20 20">
